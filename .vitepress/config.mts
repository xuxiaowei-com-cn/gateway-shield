...
export default defineConfig({
  title: "网盾",
  description: "一个基于 Spring Gateway 的代理项目",
  lang: 'zh-CN',
  base: '/gateway-shield',
  head: [
    [ 'link', { rel: 'icon', href: '/gateway-shield/favicon.ico' } ],
    [ 'script', { id: 'baidu' },
      `
      var _hmt = _hmt || [];
      (function() {
        var hm = document.createElement("script");
        hm.src = "https://hm.baidu.com/hm.js?92f29686d43f905790951401bf3392fc";
  ...
  themeConfig: {
    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: '快速开始（未完成）', link: '/guide/getting-started' },
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: '删除响应头', link: 'remove-response-header' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/xuxiaowei-com-cn/gateway-shield/' },
    ...
    editLink: {
      text: '在 Gitee 上编辑此页面',
      pattern: ({ filePath }) => {
        return `https://gitee.com/xuxiaowei-com-cn/gateway-shield/edit/docs/${filePath}`
        // return `https://framagit.org/xuxiaowei-com-cn/gateway-shield/-/edit/docs/${filePath}`
        // return `https://github.com/xuxiaowei-com-cn/gateway-shield/edit/docs/${filePath}`
      },
    },
